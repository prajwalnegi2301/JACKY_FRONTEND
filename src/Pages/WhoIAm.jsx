...
const CollabWithUs = () => {
  ...
  const partnerUsForm = async (e) => {
    ...
    try {
      const { data } = await axios.post("http://localhost:8000/api/v1/partnerWithUs/partnerUs/post", {
        email,
        phone,
        whyYouWantToCollab,
        nameOfCompany
    ...
    <div className="min-h-screen bg-gray-100 py-12 mx-12 px-12 my-12 rounded-xl shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-lg text-gray-700 mb-12">
          <p>
            Welcome to our website! We are passionate about helping dogs and their owners build strong, positive relationships through effective training techniques.
          </p>
          <p className="mt-4">
            Our team of experienced trainers is dedicated to providing personalized training programs tailored to the unique needs of each dog. Whether you're looking for basic obedience training, advanced skills, or behavior modification, we are here to help.
          </p>
          <p className="mt-4">
            At our facility, we believe in using positive reinforcement methods that are both effective and humane. We strive to create a fun and supportive environment where dogs can learn and grow.
          </p>
          <p className="mt-4">
            Thank you for choosing us as your partner in training your beloved pet. We look forward to working with you and your dog!
          </p>
        </div>
